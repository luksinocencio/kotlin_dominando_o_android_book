package com.devmeist3r.navegacao
...
class SecondLevelFragment: Fragment() {
    ...
    companion object {
        ...
        private const val EXTRA_TEXT_COLOR = "corBg"
        private const val EXTRA_BG_COLOR = "corTexto"

        fun newInstance(text: String, background: Int, textColor: Int): SecondFragment {
            val params = Bundle()
