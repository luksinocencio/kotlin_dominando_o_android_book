package com.devmeist3r.persistencia
...
class MainActivity : AppCompatActivity() {
    ...
    private fun btnReadClick() {
        ...
        when (type) {
            ...
            R.id.rbExtenalPriv -> loadFromExternal(true)
    ...
    private fun btnSaveClick() {
        ...
        when (type) {
            ...
            R.id.rbExtenalPriv -> saveToExternal(true)
    ...
    private fun saveToInternal() {
        try {
            ...
            Log.e("NGVL", "saveToInternal: Erro ao salvar", e)
        }
    }
    ...
    private fun loadFromInternal() {
        try {
            ...
            Log.e("NGVL", "loadFromInternal: Error ao carregar arquivo", e)
        }
    }
            ...
            if (myDir?.exists() == true) {
                ...
                if(txtFile.exists()) {
                    try {
                        ...
                        Log.d("NGVL", "loadFromExternal: Erro ao carregar arquivo", e)
                    }
                }
            }
        } else {
            Log.e("NGVL", "loadFromExternal: SD Card indisponível")
        }
    }

    private fun getExternalDir(privateDir: Boolean) = if(privateDir) getExternalFilesDir(null)
...
//        }
        ...
        if (Environment.MEDIA_MOUNTED == state) {
           ...
           try {
               ...
               Log.d("NGVL", "saveToExternal: Erro ao salvar arquivo", e)
           }
        } else {
            Log.e("NGVL", "saveToExternal: Não é possivel escrever no SD Card")
        }
    }
